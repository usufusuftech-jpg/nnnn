        ...
        <div className="w-full max-w-md space-y-6">
          ...
          {!roomKey ? (
            <button
              ...
              disabled={loading}
              className="w-full py-4 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold text-lg shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
            >
            ...
            <div className="space-y-4 animate-fadeIn">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={handleEnter}
                  className="flex-1 py-3 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium hover:scale-[1.02] transition-all duration-200"
                >
                  🚪 Enter Room
                </button>
              </div>
