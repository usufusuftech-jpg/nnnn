                      ...
                      <td className="px-4 py-3 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="px-2.5 py-1 text-xs bg-red-500/10 text-red-300 rounded-lg hover:bg-red-500/20 border border-red-500/20 hover:border-red-500/40 disabled:opacity-50 transition-colors"
                          >
                          ...
                          <button
                            ...
                            disabled={actionLoading === room.key}
                            className="px-2.5 py-1 text-xs bg-orange-500/10 text-orange-300 rounded-lg hover:bg-orange-500/20 border border-orange-500/20 hover:border-orange-500/40 disabled:opacity-50 transition-colors"
                          >
                            Ban
                          </button>
                        </div>
